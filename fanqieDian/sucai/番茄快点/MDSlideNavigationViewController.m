...
- (void) viewAppearFromLeft
{
    ...
    self.navigationItem.leftBarButtonItem.customView.transform = CGAffineTransformMakeTranslation(-60, 0);
    ...
    //[self.navigationItem.leftBarButtonItem.customView setTransform:CGAffineTransformMakeTranslation(0, 0)];
     self.navigationItem.leftBarButtonItem.customView.transform = CGAffineTransformMakeTranslation(0, 0);
